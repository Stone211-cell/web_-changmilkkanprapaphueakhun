          ...
          >
            <div className="flex flex-col h-full">
              <div className="mb-3 sm:mb-6">
                <svg width="28" height="22" viewBox="0 0 40 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="text-blue-100 sm:w-[40px] sm:h-[30px]">
                ...
                <div className="flex flex-col">
                  ...
                  <div className="flex items-center gap-2">
                    <div className="flex gap-0.5">
                      {[1, 2, 3, 4, 5].map((s) => (
                        <svg key={s} className="w-2.5 h-2.5 sm:w-3.5 sm:h-3.5 text-blue-500" fill="currentColor" viewBox="0 0 20 20">
